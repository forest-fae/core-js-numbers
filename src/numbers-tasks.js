 ...
 *   (0,1) (0,1)     => 0
 */
// косинус в -1 степени (или арккосинус) угла равен (x1 * x2 + y1 * y2) деленное на квадратный корень x^2 + y^2 для каждого вектора,
// т. е. Math.sqrt(x1 ** 2 + y1 ** 2) * на то же для x2, y2
...
function getLastDigit(value) {
  ...
  return stringed.length > 1 ? value % 10 : value;
}
 ...
 *   17 => true
 */
// можно сделать поиск только до квадратного корня заданного числа, что актуально для больших чисел ( i < Math.sqrt(n))
 ...
 *   15  => false
 */
// power of two = 2 in nth power, 2 is the base.
